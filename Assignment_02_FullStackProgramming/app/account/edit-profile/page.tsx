  ...
  return (
    <div className="w-full">
      <div className="text-xs text-blue-600 mb-6 border-b pb-2">
        Home &gt; User Account &gt; <span className="text-gray-600">Edit profile details</span>
      </div>

      <h2 className="text-2xl font-bold mb-4 text-slate-800">Edit Profile details</h2>
      ...
      <div className="bg-gray-100 p-6 md:p-10 mb-10">
        ...
        <form className="max-w-xl space-y-4">
          ...
          <div className="flex items-center mt-6">
            ...
            <button type="submit" className="bg-[#86B738] text-white font-bold px-6 py-2 text-xs uppercase hover:bg-green-600 transition">
              Update Details
            </button>
          </div>
        </form>
