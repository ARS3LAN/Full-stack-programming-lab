  ...
  return (
    <div className="w-full">
      <div className="text-xs text-blue-600 mb-6 border-b pb-2">
        Home &gt; User Account &gt; <span className="text-gray-600">Order details</span>
      </div>

      <h2 className="text-2xl font-bold mb-4 text-slate-800">Order Details</h2>
      ...
      <div className="bg-gray-100 p-6 md:p-10 mb-10">
        ...
        <div className="text-xs text-slate-800 space-y-2 mb-10">
          ...
          <p><span className="text-gray-600 w-16 inline-block">Acc# :</span> December 21 2014</p>
          <p><span className="text-gray-600 w-16 inline-block">BIC :</span> $2500</p>
        </div>
