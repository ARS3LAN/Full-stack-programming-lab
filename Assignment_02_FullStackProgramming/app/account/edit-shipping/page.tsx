...
export default function EditShippingAddressPage() {
  return (
    <div className="w-full">
      ...
      <h2 className="text-2xl font-bold mb-4 text-slate-800">Edit Shipping Address</h2>
        ...
        <form className="max-w-xl space-y-4">
          {[
            ...
            <div key={idx} className="flex items-center">
              ...
              <input type={field.type} className="flex-1 border border-gray-300 p-2 text-sm bg-white" />
            </div>
          ))}
